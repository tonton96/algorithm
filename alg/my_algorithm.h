...
namespace alg
{
    ...
    // Tinh gia tri bieu thuc hau to (cac toan tu, dau cac nhau 1 dau ' ')
    double calPostfix(const string &str);

    // Chuyen trung to sang hau to (cac toan tu, dau cac nhau 1 dau ' ')
